                            ...
                            <form method="POST" action="{{ route('fournisseurs.update', $fournisseur) }}">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" class="form-control @error('contact_personne') is-invalid @enderror"
                                               id="contact_personne" name="contact_personne" value="{{ old('contact_personne', $fournisseur->contact_personne) }}" required>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('adresse') is-invalid @enderror"
                                           id="adresse" name="adresse" value="{{ old('adresse', $fournisseur->adresse) }}" required>
                                    @error('adresse')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
