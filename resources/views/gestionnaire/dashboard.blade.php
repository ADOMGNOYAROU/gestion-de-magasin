...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">
            <i class="fas fa-building"></i> {{ $stats['magasin']->nom }}
            <small class="text-muted">{{ $stats['magasin']->localisation }}</small>
        </h1>
        ...
        <div class="col-xl-3 col-md-6 mb-4">
            <div class="stat-card stat-card-primary h-100">
                ...
                <div class="stat-card-body">
                    ...
                    <div class="stat-card-value">{{ $stats['boutiques'] }}</div>
                </div>
            </div>
        </div>
        ...
        <div class="col-xl-3 col-md-6 mb-4">
            <div class="stat-card stat-card-info h-100">
                ...
                <div class="stat-card-body">
                    ...
                    <div class="stat-card-value">{{ $stats['ventes_boutiques'] }}</div>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <div class="row g-3">
                        <div class="col-md-3">
                            <a href="{{ route('boutiques.index') }}" class="quick-action">
                                <div class="quick-action-icon quick-action-icon-primary"><i class="fas fa-store-alt"></i></div>
                                <div class="quick-action-title">Boutiques</div>
                                <div class="quick-action-desc">Gérer mes boutiques</div>
                            </a>
                        </div>
                        <div class="col-md-3">
                            <a href="{{ route('entrees-stock.index') }}" class="quick-action">
                                <div class="quick-action-icon quick-action-icon-success"><i class="fas fa-plus-circle"></i></div>
                                <div class="quick-action-title">Entrées de stock</div>
                                <div class="quick-action-desc">Réceptionner du stock</div>
                            </a>
                        </div>
                        <div class="col-md-3">
                            <a href="{{ route('transferts.index') }}" class="quick-action">
                                <div class="quick-action-icon quick-action-icon-warning"><i class="fas fa-exchange-alt"></i></div>
                                <div class="quick-action-title">Transferts</div>
                                <div class="quick-action-desc">Vers mes boutiques</div>
                            </a>
                        </div>
                        <div class="col-md-3">
