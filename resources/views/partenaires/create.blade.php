    ...
    <div class="row">
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h1 class="h3 mb-0 text-gray-800">Créer un Nouveau Partenaire</h1>
                            ...
                            <form method="POST" action="{{ route('partenaires.store') }}">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('type_partenariat') is-invalid @enderror"
                                           id="type_partenariat" name="type_partenariat" value="{{ old('type_partenariat') }}" required>
                                ...
                                <div class="d-flex justify-content-end">
                                    ...
                                    <button type="submit" class="btn btn-primary">
                                        <i class="fas fa-save"></i> Créer le Partenaire
                                    </button>
                                </div>
                            </form>
                        </div>
