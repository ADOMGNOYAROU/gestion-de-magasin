        ...
        <tbody>
            @forelse($ventes as $vente)
                <tr>
                    ...
                    <td>{{ $vente->produit->categorie }}</td>
                    <td>{{ $vente->boutique->nom }}</td>
                    <td>{{ $vente->boutique->magasin->nom }}</td>
                    <td class="text-center">{{ $vente->quantite }}</td>
                    <td class="text-right">{{ number_format($vente->prix_unitaire, 0, ',', ' ') }} FCFA</td>
                    <td class="text-right">{{ number_format($vente->prix_total, 0, ',', ' ') }} FCFA</td>
                    <td class="text-right">{{ number_format($vente->benefice, 0, ',', ' ') }} FCFA</td>
                </tr>
            @empty
                <tr>
