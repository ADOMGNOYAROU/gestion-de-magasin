    ...
    <div class="row mb-4">
        <div class="col-12">
            <h1 class="h3 mb-0 text-gray-800">
                <i class="fas fa-credit-card text-primary"></i> Gestion de l'abonnement (Paystack)
            </h1>
        </div>
    </div>
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <div class="text-center mb-4">
                        ...
                        <p class="text-5xl font-bold text-success my-3">
                    ...
                    <div class="d-grid gap-2">
                        <form action="{{ route('paystack.initialize') }}" method="POST">
                            ...
                            <button type="submit" class="btn btn-success">
                                <i class="fas fa-credit-card"></i> Payer avec Paystack
                            </button>
                        </form>
                        
                        @if($tenant->paystack_subscription_code)
                        <form action="{{ route('paystack.cancel') }}" method="POST">
                            @csrf
        ...
        <div class="col-xl-4 col-lg-6 mb-4">
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('paystack.initialize') }}" method="POST" id="upgradeForm">
                        @csrf
