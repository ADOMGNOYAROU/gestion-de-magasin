                        ...
                        <div class="card-body">
                            <table class="table table-borderless">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span class="badge bg-info fs-6">{{ $transfert->quantite }}</span>
                                    </td>
                                </tr>
                            </table>
                        </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="alert alert-warning py-2">
                                ...
                                Stock diminué de {{ $transfert->quantite }} unités
                            </div>
                            
                            <div class="alert alert-success py-2">
                                <i class="fas fa-plus-circle"></i>
                                <strong>Boutique Destination</strong><br>
                                Stock augmenté de {{ $transfert->quantite }} unités
                            </div>
            ...
            <div class="card mt-3">
                <div class="card-body">
                    <small class="text-muted">
                        ...
                        <strong>Créé le :</strong> {{ $transfert->created_at->format('d/m/Y H:i:s') }}<br>
                        <strong>Modifié le :</strong> {{ $transfert->updated_at->format('d/m/Y H:i:s') }}
                    </small>
                </div>
            </div>
        </div>
