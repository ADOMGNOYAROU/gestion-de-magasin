                            ...
                            <tbody>
                                @forelse($ventes as $vente)
                                    <tr>
                                        ...
                                        <td>
                                            <span class="badge bg-warning">{{ $vente->quantite }}</span>
                                        </td>
                                        ...
                                        <td>
                                            <span class="badge bg-success">{{ number_format($vente->benefice, 0, ',', ' ') }} FCFA</span>
                                        </td>
                                        <td>
                ...
                <div class="col-md-3">
                    <div class="card bg-success text-white">
                        <div class="card-body">
                            ...
                            <h3>{{ number_format($ventes->sum('prix_total'), 0, ',', ' ') }} FCFA</h3>
                        </div>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="card bg-info text-white">
                        <div class="card-body">
                            ...
                            <h3>{{ number_format($ventes->sum('benefice'), 0, ',', ' ') }} FCFA</h3>
                        </div>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="card bg-warning text-white">
                        <div class="card-body">
                            ...
                            <h3>{{ $ventes->sum('prix_total') > 0 ? round(($ventes->sum('benefice') / $ventes->sum('prix_total')) * 100, 1) : 0 }}%</h3>
                        </div>
                    </div>
                </div>
            </div>
