    ...
    <div class="row">
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center mb-4">
                ...
                <div>
                    <a href="<?php echo e(route('rapports.partenaires.pdf')); ?>" class="btn btn-outline-info me-2 <?php echo e(hideIfCannot('view-rapports-partenaires')); ?>">
                        <i class="fas fa-handshake"></i> Rapport Partenaires
                    </a>
                    <a href="<?php echo e(route('entrees-stock.create')); ?>" class="btn btn-success">
            ...
            <div class="card mb-4">
                <div class="card-body">
                    <form method="GET" action="<?php echo e(route('entrees-stock.index')); ?>">
                        <div class="row">
                            <div class="col-md-4">
                            ...
                            <div class="col-md-2">
                                ...
                                <?php if($search || $date_debut || $date_fin): ?>
                                    <a href="<?php echo e(route('entrees-stock.index')); ?>" class="btn btn-outline-secondary">
                            ...
                            <tbody>
                                <?php $__empty_1 = true; $__currentLoopData = $entrees; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $entree): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr>
                                        ...
                                        <td>
                                            <span class="badge bg-success">+<?php echo e($entree->quantite); ?></span>
                                        </td>
                                        <td><?php echo e(number_format($entree->prix_unitaire, 0, ',', ' ')); ?> FCFA</td>
                                        <td>
                                            <strong><?php echo e(number_format($entree->quantite * $entree->prix_unitaire, 0, ',', ' ')); ?> FCFA</strong>
                                        </td>
                                        <td>
                                            <div class="btn-group" role="group">
                                                <a href="<?php echo e(route('entrees-stock.show', $entree->id)); ?>" 
                ...
                <div class="col-md-3">
                    <div class="card bg-primary text-white">
                        <div class="card-body">
                            ...
                            <h3><?php echo e($entrees->total()); ?></h3>
                        </div>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="card bg-success text-white">
                        <div class="card-body">
                            ...
                            <h3><?php echo e(number_format($entrees->sum('quantite'), 0, ',', ' ')); ?></h3>
                        </div>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="card bg-info text-white">
                        <div class="card-body">
                            ...
                            <h3><?php echo e(number_format($entrees->sum(function($e) { return $e->quantite * $e->prix_unitaire; }), 0, ',', ' ')); ?> FCFA</h3>
                        </div>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="card bg-warning text-white">
                        <div class="card-body">
                            ...
                            <h3><?php echo e(number_format($entrees->avg('prix_unitaire'), 0, ',', ' ')); ?> FCFA</h3>
                        </div>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\gestion-magasin\resources\views/entrees-stock/index.blade.php ENDPATH**/ ?>