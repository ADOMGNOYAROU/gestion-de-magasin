                    ...
                    <div class="card shadow h-100">
                        <div class="card-body">
                            <div class="text-center">
                                ...
                                <div class="d-grid">
                                    <a href="<?php echo e(route('rapports.stock.pdf')); ?>" class="btn btn-primary">
                    ...
                    <div class="card shadow h-100">
                        <div class="card-body">
                            <div class="text-center">
                                ...
                                <div class="d-grid">
                                    <a href="<?php echo e(route('rapports.ventes.form')); ?>" class="btn btn-success">
                        ...
                        <div class="card shadow h-100">
                            <div class="card-body">
                                <div class="text-center">
                                    ...
                                    <div class="d-grid">
                                        <a href="<?php echo e(route('rapports.partenaires.pdf')); ?>" class="btn btn-info">
                                            <i class="fas fa-file-pdf"></i> Générer PDF
                                        </a>
                                    </div>
                                </div>
                    ...
                    <div class="card shadow">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="d-grid">
                                        <a href="<?php echo e(route('ventes.index')); ?>" class="btn btn-outline-success">
                                ...
                                <div class="col-md-3">
                                    <div class="d-grid">
                                        <a href="<?php echo e(route('entrees-stock.index')); ?>" class="btn btn-outline-warning">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\gestion-magasin\resources\views/rapports/index.blade.php ENDPATH**/ ?>