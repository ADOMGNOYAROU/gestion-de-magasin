...
<body class="font-sans antialiased">
    <div class="min-h-screen flex bg-gray-50">
        ...
        <div class="relative hidden w-1/2 flex-col justify-between overflow-hidden bg-gradient-to-br from-green-800 via-green-900 to-slate-900 p-12 text-white lg:flex">
            ...
            <p class="relative text-xs text-green-100/60">&copy; <?php echo e(date('Y')); ?> Gestion de Magasin. Tous droits réservés.</p>
        </div>
...
<?php endif; ?>
                ...
                <form method="POST" action="<?php echo e(route('login')); ?>" class="mt-8 space-y-5" x-data="{ loading: false, showPassword: false }" x-on:submit="loading = true">
                    <?php echo csrf_field(); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.text-input','data' => ['id' => 'email','type' => 'email','name' => 'email','value' => old('email'),'class' => 'block w-full pl-10','placeholder' => 'vous@exemple.com','required' => true,'autofocus' => true,'autocomplete' => 'username']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'email','type' => 'email','name' => 'email','value' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(old('email')),'class' => 'block w-full pl-10','placeholder' => 'vous@exemple.com','required' => true,'autofocus' => true,'autocomplete' => 'username']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
                            <?php if(Route::has('password.request')): ?>
                                <a class="text-sm font-medium text-green-700 hover:text-green-600" href="<?php echo e(route('password.request')); ?>">
                                    Mot de passe oublié ?
                                </a>
                            <?php endif; ?>
                        </div>
                        <div class="relative mt-1">
                            ...
                            <?php if (isset($component)) { $__componentOriginal18c21970322f9e5c938bc954620c12bb = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal18c21970322f9e5c938bc954620c12bb = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.text-input','data' => ['id' => 'password','type' => 'password','xBind:type' => 'showPassword ? \'text\' : \'password\'','name' => 'password','class' => 'block w-full px-10','placeholder' => '••••••••','required' => true,'autocomplete' => 'current-password']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('text-input'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'password','type' => 'password','x-bind:type' => 'showPassword ? \'text\' : \'password\'','name' => 'password','class' => 'block w-full px-10','placeholder' => '••••••••','required' => true,'autocomplete' => 'current-password']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal18c21970322f9e5c938bc954620c12bb)): ?>
<?php $attributes = $__attributesOriginal18c21970322f9e5c938bc954620c12bb; ?>
...
<?php endif; ?>
                ...
                <p class="mt-8 text-center text-sm text-gray-500">
                    ...
                    <a href="<?php echo e(route('register')); ?>" class="font-medium text-green-700 hover:text-green-600">S'inscrire</a>
                </p>
            </div>
        </div>
    </div>
...
<?php /**PATH C:\Users\adomg\OneDrive\Desktop\gestion\resources\views/auth/login.blade.php ENDPATH**/ ?>