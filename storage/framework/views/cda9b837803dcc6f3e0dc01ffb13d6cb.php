                ...
                <div class="col-md-8">
                    <div class="card">
                        ...
                        <div class="card-body">
                                    ...
                                    <select class="form-select" id="boutique_id" name="boutique_id" required>
                                        ...
                                        <?php $__currentLoopData = $boutiques; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $boutique): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($boutique->id); ?>" 
                                                    data-magasin="<?php echo e($boutique->magasin->nom ?? ''); ?>">
                                                <?php echo e($boutique->nom); ?> - <?php echo e($boutique->localisation); ?>
                            ...
                            <?php else: ?>
                                <?php if(Auth::user()->boutique): ?>
                                    <input type="hidden" id="boutique_id" value="<?php echo e(Auth::user()->boutique_id); ?>">
                                    <div class="alert alert-info">
                                        <i class="fas fa-store"></i>
                                        <strong>Boutique :</strong> <?php echo e(Auth::user()->boutique->nom); ?>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.getElementById('btn_confirmer_vente').addEventListener('click', function() {
        ...
        fetch('<?php echo e(route("ventes.store")); ?>', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\gestion-magasin\resources\views/ventes/create.blade.php ENDPATH**/ ?>